...
$("#btn5").click(function(){
    if(document.getElementById("a54").checked==true)
     {
 ...
 $("#btn6").click(function(){
    if(document.getElementById("a62").checked==true)
     {
...
$("#btn8").click(function(){
if(document.getElementById("a82").checked==true)
 {
...
// end
$("#btn9").click(function(){
    if(document.getElementById("a91").checked==true)
     {
